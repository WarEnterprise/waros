...
fn try_kernel_main(boot_data: &'static mut BootInfo) -> Result<(), &'static str> {
    ...
    match cpu_interrupts::without_interrupts(|| exec::smoke::run_abi_fault_smoke()) {
    ...
    match cpu_interrupts::without_interrupts(|| exec::smoke::run_abi_wait_smoke()) {
    ...
    match cpu_interrupts::without_interrupts(|| exec::smoke::run_abi_stat_smoke()) {
    ...
    match cpu_interrupts::without_interrupts(|| exec::smoke::run_abi_readdir_smoke()) {
    ...
    match cpu_interrupts::without_interrupts(|| exec::smoke::run_abi_path_smoke()) {
    ...
    match cpu_interrupts::without_interrupts(|| exec::smoke::run_abi_write_smoke()) {
